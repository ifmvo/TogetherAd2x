...
//    }
    ...
    private fun requestAd() {
        ...
        TogetherAdSplash.showAdFull(
            activity = this,
            splashConfigStr = splashConfigAd,
            adConstStr = TogetherAdConst.AD_SPLASH,
            adsParentLayout = mFlAdContainer,
            adListener = object : TogetherAdSplash.AdListenerSplashFull {
