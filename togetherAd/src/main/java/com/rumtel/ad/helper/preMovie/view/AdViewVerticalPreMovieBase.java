 ...
 */
public abstract class AdViewVerticalPreMovieBase extends FrameLayout {
    ...
    public AdViewVerticalPreMovieListener adViewListener;

    public AdViewVerticalPreMovieBase(@NonNull Context context) {
        super(context);
        initView();
    }

    public AdViewVerticalPreMovieBase(Context context, Boolean needTimer) {
        super(context);
        this.needTimer = needTimer;
        initView();
    }

    public AdViewVerticalPreMovieBase(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public AdViewVerticalPreMovieBase(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public AdViewVerticalPreMovieBase setAdViewVerticalPreMovieListener(AdViewVerticalPreMovieListener adViewListener) {
     ...
     * 监听回调
     */
    public interface AdViewVerticalPreMovieListener {
